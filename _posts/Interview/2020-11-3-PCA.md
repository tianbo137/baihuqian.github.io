...
$$\vec{x} \cdot \vec{y} = (a_1,a_2,\cdots,a_n) \cdot (b_1,b_2,\cdots,b_n)^\mathsf{T} = a_1b_1+a_2b_2+\cdots+a_nb_n.$$

Geometrically，the inner product of $$\vec{x}$$ and $$\vec{y}$$ equals the length of the projection of $$\vec{x}$$ onto $$\vec{y}$$.
#### 1.2 Coviarance 
