...
&= \left( \begin{bmatrix} \langle \vec{f}_1, \ \vec{e}_1 \rangle&  \langle \vec{f}_1, \ \vec{e}_2 \rangle &\cdots & \langle \vec{f}_1, \ \vec{e}_n \\  \langle \vec{f}_2, \ \vec{e}_1 & \langle \vec{f}_2, \ \vec{e}_2&\cdots & \langle \vec{f}_2, \ \vec{e}_n \\\vdots & \vdots & \ddots & \vdots\\ \langle \vec{f}_n, \ \vec{e}_1& \langle \vec{f}_n, \ \vec{e}_2&\cdots & \langle \vec{f}_n, \ \vec{e}_n\end{bmatrix}\right) \cdot \left( \begin{array}{c} a_1 \\ a_2 \\ \vdots \\ a_n \end{array} \right)
\end{align}
$$
