...
$$\langle \vec{x},\  \vec{y} \rangle = ( a_1,a_2,\cdots,a_n ) \cdot ( \begin{array}{c}\langle \vec{x}, \ f_1 \rangle\\ \langle \vec{x}, \ f_2 \rangle \\ \vdots \\ \langle \vec{x}, \ f_n \rangle \end{array} ) (b_1,b_2,\cdots,b_n) = a_1b_1+a_2b_2+\cdots+a_nb_n.$$
...
$$ \left( \begin{array}{c}\langle \vec{x}, \ f_1 \rangle\\ \langle \vec{x}, \ f_2 \rangle \\ \vdots \\ \langle \vec{x}, \ f_n \rangle \end{array} \right) $$
