...
Stanford NLP class in 2019 is given by Professor Maning, which is aimed at exploring the fundamental concepts of NLP and its role in current and emerging technologies. 
...
What you will learn
* 1. Computational properties of natural languages
* 2. Neural network models for language understanding tasks
* 3. Word vectors, syntactic, and semantic processing
* 4. Coreference, question answering, and machine translation
